...
public class DeliverReq  extends com.tourzj.mms.req.Request  implements java.io.Serializable {
    public DeliverReq() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://req.mms.tourzj.com", "DeliverReq"));
    }
