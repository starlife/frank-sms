...
<body>
	...
	<table class="ui-widget">
		<tr>
			<td>彩信名称:<font color="red">*</font>
			</td>
			<td><s:property value="#mmsFile.mmsName" /></td>
		</tr>
					...
					<table style="border: 0px;">
						<tr>
							<s:iterator value="#mmsFile.frameMap">
								<!-- 记录frameSize -->
								<span id='frameSize${key}' style="display: none"> 
										...
										<tr>
											<td align="center">
												<input name="radioselect" type="radio"
													...
													value="${key}" onclick="chooseFrame(${key});" />选择
											</td>
										</tr>
										<tr>
											<td>
		...
		<tr>
			<td>当前帧大小:</td>
			<td><span id="currentFrameSize"></span></td>
		</tr>
		<tr>
			<td>当前帧播放时间：</td>
			<td><span id="currentFrameDuringTime"></span>(秒)</td>
		</tr>
