...
public class MessageUtil
{
	 ...
	 * @return
	 */
	public static SubmitMessage[] createSubmitMessage(String nodeid,
			String spid, String spnumber, String serviceCode,
			String[] desttermid, String message, String param)
	{
		...
		else
		{
			...
			SubmitMessage sm = createSubmitMessage(nodeid, 1, 1, spid,
					spnumber, serviceCode, desttermid, msgByte, param);
			smList[0] = sm;
	...
	public static SubmitMessage createSubmitMessage(String nodeid, int pkTotal,
			int pkNumber, String spid, String spnumber, String serviceCode,
			String[] desttermid, byte[] msgcontent, String param)
	{
		...
		Submit submit = new Submit(spid, spnumber, serviceCode, desttermid,
				msgcontent, param);
		SubmitMessage sm = new SubmitMessage(nodeid, submit);
		return sm;
	}
