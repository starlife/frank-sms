...
public class Submit
{
	...
	/**
	 * 计费号码 有的话需要配置文件提供 手机号码前加“86”国别标志；当且仅当群发且对用户收费时为空；
	...
	/**
	 * 计费类型 0 “短消息类型”为“发送”，对“计费用户号码”不计信息费，此类话单仅用于核减SP对称的信道费 1 对“计费用户号码”免费 2
	 * 对“计费用户号码”按条计信息费 3 对“计费用户号码”按包月收取信息费 4 对“计费用户号码”的收费是由SP实现
	 */
