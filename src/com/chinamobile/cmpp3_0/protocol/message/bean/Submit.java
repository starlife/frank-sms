...
public class Submit
{
	...
	/**
	 * 计费号码类型 枚举： 0 真实号码 1 伪码
	 */
	public int feeTermType=0;
	...
	/**
	 * 目的号码是真实号码还是伪码 枚举：0 真实号码 1 伪码
	 */
	public int destTermType=0;
	/**
	 * 消息长度（短信内容的字节数）
	 */
	...
	public void setParams(String param)
	{
		...
		if ((value = getValue(param, "linkID")) != null)
		{
			linkID = value;
		}
	...
	public String toString()
	{
		...
		sb.append(" FeeTermType-byte    : " + this.feeTermType + "\r\n");
		...
		sb.append(" DestTermType-byte   : " + this.destTermType + "\r\n");
		...
		sb.append(" LinkID-char         : " + this.linkID + "\r\n");
