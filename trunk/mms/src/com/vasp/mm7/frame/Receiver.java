...
public class Receiver extends MM7Receiver {
	...
	public void dealDeliveryReport(MM7DeliveryReportReq deliverReportReq)
	{
		...
		if(!Tools.isBlank(messageid))
		{
			SubmitBean bean=dao.getSubmitBeanByMessageid(messageid);
			if(bean!=null)
			{
