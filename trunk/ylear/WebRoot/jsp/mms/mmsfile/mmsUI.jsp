...
.link {
	...
	function choiceFrame_callback()
	{
		...
		parent.choiceFrame_callback(frameid,mmsSize,frameSize,duringTime,frameText);
	}
						...
						<td>
							...
							<table>
								...
								checked="checked"
											...
											value="${key}"
											onclick="parent.choiceFrameMethod(${key},'<s:url action="mmsEditor!choiceFrame"/>');" />
										选择|
										<a class="link"
