...
<@html>
	<@head title="单位维护">
		...
		<link rel="stylesheet" href="${ctx}/js/JQueryzTreev3.2/css/zTreeStyle/zTreeStyle.css" type="text/css">
		
		<script type="text/javascript" src="${ctx}/js/jquery.js"></script>
		<script type="text/javascript" src="${ctx}/js/global.js"></script>
		
		<script type="text/javascript" src="${ctx}/js/JQueryzTreev3.2/js/jquery.ztree.core-3.2.js"></script>
		<script type="text/javascript" src="${ctx}/js/JQueryzTreev3.2/js/jquery.ztree.excheck-3.2.js"></script>
	...
	<@body posArr = positions >
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td width="2"><img src="${ctx}/images/info_title_left.gif" width="2" height="28"></td>
		    <td style="background:url(${ctx}/images/info_title_bg.gif) repeat-x;">
			    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			      <tr>
			        <td width="30" align="center">
			        	<img src="${ctx}/images/icon_up.gif" width="15" height="14" border="0" id="Contraction_Img" 
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab_cel" >
			<tr>
				<td>
					<a href="javascript:openOrCloseTree(true)">全部展开</a> | <a href="javascript:openOrCloseTree(false)">全部关闭</a><br>
		...
		<script type="text/javascript">
			...
			var zNodes =[
				{ id:0, pId:-1, name:"所属单位", open:true, icon:"${ctx}/css/zTreeStyle/img/diy/address.png"}
