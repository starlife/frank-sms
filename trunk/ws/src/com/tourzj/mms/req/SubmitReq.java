...
public class SubmitReq  extends com.tourzj.mms.req.Request  implements java.io.Serializable {
    public SubmitReq() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://req.mms.tourzj.com", "SubmitReq"));
    }
